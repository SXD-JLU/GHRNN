...
class ArgsEvaluate():
    def __init__(self):
        ...
        #
        # self.model_path = 'model_save/' + 'DFScodeRNN_citeseer_2020-08-10 22-43-11/DFScodeRNN_citeseer_40.dat'



        # self.model_path = 'model_save/' + 'DFScodeRNN_citeseer_2020-08-10 22-51-01/DFScodeRNN_citeseer_60.dat'
        # self.model_path = 'model_save/' + 'GraphRNN_citeseer_2020-08-10 22-54-50/GraphRNN_citeseer_20.dat'
        # self.model_path = 'model_save/' + 'HRNN_Lung_2020-05-11 20-19-52/HRNN_Lung_620.dat'
        self.model_path = 'model_save/' + 'DFScodeRNN_Lung_2020-05-11 12-52-59/DFScodeRNN_Lung_540.dat'
        ...
        #special to ENZYMES，cora, citeseer
        # self.count = 320
        # self.batch_size = 32  # Must be a factor of count
        # self.metric_eval_batch_size = 32

        # Specific DFScodeRNN
        # self.max_num_edges = 736
        # self.max_num_edges = 763
        self.max_num_edges = 57

        # Specific to GraphRNN
        self.min_num_node = 11
        self.max_num_node = 6
        # self.min_num_node = 333 #citeseer:333,431
        # self.max_num_node = 431 #cora:354,539
