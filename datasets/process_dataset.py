...
def create_graphs(args):
    ...
    if 'Lung' == args.graph_type:
        ...
        min_num_nodes, max_num_nodes = 6, 50
        # min_num_edges, max_num_edges = None, None
        min_num_edges, max_num_edges = 6, 57
        ...
        min_num_nodes, max_num_nodes = 5, 50
        min_num_edges, max_num_edges = 5, 57
        ...
        random_walk_iterations = 10  # Controls size of graph
        num_factor = 1 # Controls size of dataset
        ...
        random_walk_iterations = 1800 # Controls size of graph
        # num_factor = 5  # Controls size of dataset
        num_factor = 1  # Controls size of dataset

        # min_num_nodes, max_num_nodes = None, None
        min_num_nodes, max_num_nodes = 270, None
        # min_num_edges, max_num_edges = 20, None
        min_num_edges, max_num_edges = 543, None
